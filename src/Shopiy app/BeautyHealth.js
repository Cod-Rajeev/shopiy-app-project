...
import helth from './img/helth.jpeg'

function BeautyHealth() {
  return (
    <>
    <h1 className='text-center text-danger fw-bold text-decoration-underline'>Beauty & Health Product</h1>
    <header className="bg-info py-5">
        ...
        <marquee><h1 className='fw-bold text-warning-emphasis fst-italic text-decoration-underline'>Holi Specel Offer 70% off</h1></marquee>
               <div className="text-center text-white">
                   <h1 className="display-4 fw-bolder">Tha Bauty & Health Product</h1>
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={beauty} height={200} alt="img" />
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={helth} alt="..." />
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={helth} alt="img" />
