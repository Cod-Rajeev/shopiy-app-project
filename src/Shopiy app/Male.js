...
<h1 className='text-center text-danger fw-bold text-decoration-underline'>Top Fashion Man Shirt</h1>
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={shirt1} height={150} alt="..." />
                            ...
                            <div className="card-body p-4">
                                <div className="text-center">
                                    ...
                                    <div className="d-flex justify-content-center small text-warning mb-2">
                                        <div className="bi-star-fill">28/04/2024</div>
                                        <div className="bi-star-fill">Tak</div>
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={shirt1} height={150} alt="img" />
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={paint} alt="..." />
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={paint} alt="img" />
