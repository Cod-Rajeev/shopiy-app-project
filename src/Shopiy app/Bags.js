...
import boybag from './img/boybag.jpeg'
import girlbag from './img/girlbag.jpeg'
...
function Bags() {
  return (
    ...
    <section className="py-5">
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={boybag} alt="..." />
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={boybag} alt="img" />
        ...
        <h1 className='text-center text-danger fw-bold text-decoration-underline'>Fancy Girl Bag</h1>
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={girlbag} alt="..." />
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={girlbag} alt="img" />
