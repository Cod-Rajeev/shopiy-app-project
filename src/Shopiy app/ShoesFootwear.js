...
import slipper from './img/slipper.jpeg'





function ShoesFootwear() {
  return (
    <>
    <h1 className='text-center text-danger fw-bold text-decoration-underline'>Shoes & Footwear</h1>
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={shoes} alt="img" />
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={slipper} alt="..." />
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={slipper} alt="img" />
