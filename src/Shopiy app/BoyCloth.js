...
import shirt from './img/boyshirt.jpeg'
import pent from './img/boypent.jpeg'

function BoyCloth() {
  return (
    <>
    <h1 className='text-center text-danger fw-bold text-decoration-underline'>Boy Wear</h1>
    <header className="bg-info py-5">
        ...
        <h1 className='fw-bold text-warning-emphasis fst-italic text-decoration-underline'>Holi Specel Offer 70% off</h1>
               <div className="text-center text-white">
                   <h1 className="display-4 fw-bolder">Top Boys Wear</h1>
                   <p className="lead fw-normal text-white-50 mb-0">With this shop hompeage template</p>
               </div>
           </div>
       </header>
<h1 className='text-center text-danger fw-bold text-decoration-underline'>Top Fashion Boy Shirt</h1>
               ...
               <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                   ...
                   <div className="col mb-5">
                       <div className="card ">
                           ...
                           <img className="card-img-top" src={shirt} alt="img" />
                   ...
                   <div className="col mb-5">
                       <div className="card ">
                           ...
                           <img className="card-img-top" src={pent} alt="..." />
