...
import bebygirl from './img/bebygirl.jpeg'
import bebyboy from   './img/bebyboy.jpeg'
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={bebygirl} alt="..." />
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={bebygirl} alt="img" />
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={bebyboy} alt="..." />
                    ...
                    <div className="col mb-5">
                        <div className="card ">
                            ...
                            <img className="card-img-top" src={bebyboy} alt="img" />
